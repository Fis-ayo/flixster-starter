  ...
  return (
    <div className="menu-overlay" onClick={onMenuClose}>
      <div className="menu-container" onClick={(e) => e.stopPropagation()}>
        <span className="menu-close" onClick={onMenuClose}>
          &times;
        </span>
        <ul className="menu-detail">
          ...
          <li>
            ...
            <Link to="src/pages/Favorites/Favorites.jsx">Favorites</Link>
          </li>
          <li>
            <FaEye className="menu-icon" />
            <Link to="src/pages/Watched/Watched.jsx">Watched</Link>
          </li>
        </ul>
      </div>
    </div>
